...
execute store result storage helper:data/type compare byte 1 run data get storage helper:data/type target
...
execute if data storage helper:data/type {success:false} run data modify storage helper:api/data/type output set value "byte"